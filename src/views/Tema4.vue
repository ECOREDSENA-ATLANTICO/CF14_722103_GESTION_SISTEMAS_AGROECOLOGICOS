      ...
      .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        .titulo-principal.color-acento-contenido
          .titulo-principal__numero
            span 4
          h1 Etapas productivas de las especies pecuarias
        
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-12.mb-4
            .bloque-texto-g.p-3.p-sm-4.p-md-5
              .bloque-texto-g__img(
                :style="{'background-image': `url(${require('@/assets/curso/images/tema4/img_1.png')})`, 'width': '100%', 'height':'249px'}"
              )
          .col-lg-9.mb-5
        ...
        .tarjeta.bg_grad-01.mb-5(data-aos="zoom-in-up").tarjeta-slyder
          SlyderA(tipo="b").max-height
            figure
              img.w-100.img-t.m-auto(src='@/assets/curso/images/tema4/img_2.svg', alt='Texto que describa la imagen')
            figure
              img.w-100.img-t.m-auto(src='@/assets/curso/images/tema4/img_3.png', alt='Texto que describa la imagen')
            figure
              img.w-100.img-t.m-auto(src='@/assets/curso/images/tema4/img_4.svg', alt='Texto que describa la imagen')
